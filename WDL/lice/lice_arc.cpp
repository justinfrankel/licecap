...
static bool CachedCircle(LICE_IBitmap* dest, float cx, float cy, float r, LICE_pixel color, float alpha, int mode, bool aa, bool fill)
{
  ...
  else if (r == 2.0f)
  {
    ...
    if (aa) {
      LICE_pixel_chan alphas[64] = {
        ...
        A(0.31), A(1.00), B(0.69), B(0.25), B(0.25), B(0.69), A(1.00), A(0.31),
        A(0.87), B(0.69), B(0.00), B(0.00), B(0.00), B(0.00), B(0.69), A(0.87),
  ...
  else if (r == 6.0f)
  {
    if (aa) {
      LICE_pixel_chan alphas[169] = {
        ...
        A(0.00), A(0.00), B(0.53), B(0.00), B(0.00), B(0.00), B(0.00), B(0.00), B(0.00), B(0.00), B(0.53), A(0.00), A(0.00),
  ...
  {
    if (aa) {
      LICE_pixel_chan alphas[225] = {
        A(0.00), A(0.00), A(0.00), A(0.00), A(0.33), A(0.71), A(0.93), A(1.00), A(0.93), A(0.71), A(0.33), A(0.00), A(0.00), A(0.00), A(0.00),
        A(0.00), A(0.00), A(0.00), A(0.75), B(0.68), B(0.29), B(0.07), B(0.00), B(0.07), B(0.29), B(0.68), A(0.75), A(0.00), A(0.00), A(0.00),
        ...
        A(0.33), B(0.68), B(0.00), B(0.00), B(0.00), B(0.00), B(0.00), B(0.00), B(0.00), B(0.00), B(0.00), B(0.00), B(0.00), B(0.68), A(0.33),
...
void LICE_Circle(LICE_IBitmap* dest, float cx, float cy, float r, LICE_pixel color, float alpha, int mode, bool aa)
{
  ...
  if (CachedCircle(dest, cx, cy, r, color, alpha, mode, aa, false)) return;
